...
public class Exercise8_7 {
	...
	public static void findDistance3D() {
		...
		int p1 = 0, p2 = 1, p3 = 2;
		double shortestDistance = distance(points[p1][0], points[p1][1], points[p2][0], points[p2][1], points[p3][0], points[p3][1]);

		// Find the distance for every 2 points
